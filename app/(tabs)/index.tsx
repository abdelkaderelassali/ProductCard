...
// 1. Define the "Shape" of a Product (Fixes the TypeScript errors)
type Product = {
  id: string;
  title: string;
  price: string;
...
export default function HomeScreen() {
  ...
  // 3. The Render Function (Typed correctly now)
...
const styles = StyleSheet.create({
  screenContainer: {
    ...
    // If you have a header, you might not need paddingTop, but keep it safe for now
    paddingTop: 10, 
  },
  listContent: {
    padding: 20,
